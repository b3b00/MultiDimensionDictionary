...
namespace consoleTests
{
    public static class Program
    {
        ...
        private static void AssertTrue(bool test, string messagePattern, int errorCode)
        {
            AssertExpiration(true, test, messagePattern, errorCode);
        }

        private static void AssertFalse(bool test, string messagePattern, int errorCode)
        {
