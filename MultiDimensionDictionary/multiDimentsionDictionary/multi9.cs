...
namespace multiDimensionalDictionary
{
    ...
    {
        protected ConcurrentDictionary<K1, MultiDimensionalDictionary<K2, K3, K4, K5, K6, K7, K8, K9, V>> Data
        {
            get;
            set;
        }
        ...
        {
            Data = new ConcurrentDictionary<K1, MultiDimensionalDictionary<K2, K3, K4, K5, K6, K7, K8, K9, V>>();
        }
        ...
        public bool ContainsKey(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7) =>
            Data.ContainsKey(k1) && Data[k1].ContainsKey(k2, k3, k4, k5, k6, k7);

        public bool ContainsKey(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8) =>
            Data.ContainsKey(k1) && Data[k1].ContainsKey(k2, k3, k4, k5, k6, k7, k8);

        public bool ContainsKey(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8, K9 k9) =>
            Data.ContainsKey(k1) && Data[k1].ContainsKey(k2, k3, k4, k5, k6, k7, k8, k9);
        ...
        public List<(K1, K2, K3, K4, K5, K6, K7, K8, K9)> GetKeys()
        {
            ...
            {
                List<(K2, K3, K4, K5, K6, K7, K8, K9)> subkeys = kvp.Value.GetKeys();
        ...
        public void Put(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8, K9 k9, V value)
        {
            ...
            var secondDimentionData = new MultiDimensionalDictionary<K2, K3, K4, K5, K6, K7, K8, K9, V>();
        ...
        public MultiDimensionalDictionary<K2, K3, K4, K5, K6, K7, K8, K9, V> Get(K1 k1)
        {
            return Data[k1];
        }

        public MultiDimensionalDictionary<K3, K4, K5, K6, K7, K8, K9, V> Get(K1 k1, K2 k2)
        {
            return Data[k1].Get(k2);
        }

        public MultiDimensionalDictionary<K4, K5, K6, K7, K8, K9, V> Get(K1 k1, K2 k2, K3 k3)
        {
            return Data[k1].Get(k2, k3);
        }

        public MultiDimensionalDictionary<K5, K6, K7, K8, K9, V> Get(K1 k1, K2 k2, K3 k3, K4 k4)
        {
            return Data[k1].Get(k2, k3, k4);
        }

        public MultiDimensionalDictionary<K6, K7, K8, K9, V> Get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5)
        {
            return Data[k1].Get(k2, k3, k4, k5);
        }

        public MultiDimensionalDictionary<K7, K8, K9, V> Get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6)
        {
            return Data[k1].Get(k2, k3, k4, k5, k6);
        }

        public MultiDimensionalDictionary<K8, K9, V> Get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7)
        {
            return Data[k1].Get(k2, k3, k4, k5, k6, k7);
        }

        public MultiDimensionalDictionary<K9, V> Get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8)
        {
        ...
        public V Get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8, K9 k9)
        {
            ...
            if (Data.TryGetValue(k1,
                    out MultiDimensionalDictionary<K2, K3, K4, K5, K6, K7, K8, K9, V> secondDimensionData))
            {
                return secondDimensionData.Get(k2, k3, k4, k5, k6, k7, k8, k9);
            }
