...
public List<(K1, K2, K3, K4, K5, K6, K7, K8, K9)> GetKeys()
        {
            ...
            foreach (var kvp in Data)
            {
                ...
                {
        keys.Add((kvp.Key, subkey.Item1, subkey.Item2, subkey.Item3, subkey.Item4, subkey.Item5, subkey.Item6, subkey.Item7, subkey.Item8));}
            }
            return keys;
}
#endregion
...
DictionaryAssertions.AssertNotNull<K9>(k9, "k9");
            ...
            if (Data.TryGetValue(k1, out MultiDimensionalDictionary<K2, K3, K4, K5, K6, K7, K8, K9, V> secondDimensionData))
            {
