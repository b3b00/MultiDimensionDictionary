...
namespace multiDimensionalDictionary
{
    ...
    {
        protected ConcurrentDictionary<K1, MultiDimensionalDictionary<K2, K3, K4, K5, K6, K7, K8, K9, K10, V>> Data
        {
            get;
            set;
        }
        ...
        public bool ContainsKey(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8, K9 k9, K10 k10) =>
            Data.ContainsKey(k1) && Data[k1].ContainsKey(k2, k3, k4, k5, k6, k7, k8, k9, k10);
        ...
        public V Get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8, K9 k9, K10 k10)
        {
            ...
            if (Data.TryGetValue(k1,
                    out MultiDimensionalDictionary<K2, K3, K4, K5, K6, K7, K8, K9, K10, V> secondDimensionData))
            {
