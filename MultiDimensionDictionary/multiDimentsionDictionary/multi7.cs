...
public class MultiDimensionalDictionary<K1, K2, K3, K4, K5, K6, K7, V>
    {
        ...
        {
            Data = new ConcurrentDictionary<K1, MultiDimensionalDictionary<K2, K3, K4, K5, K6, K7, V>>();
        }
...
public List<(K1, K2, K3, K4, K5, K6, K7)> GetKeys()
        {
            ...
            {
                List<(K2, K3, K4, K5, K6, K7)> subkeys = kvp.Value.GetKeys();
                foreach (var subkey in subkeys)
                {
        keys.Add((kvp.Key, subkey.Item1, subkey.Item2, subkey.Item3, subkey.Item4, subkey.Item5, subkey.Item6));}
            }
            return keys;
}
#endregion
...
DictionaryAssertions.AssertNotNull<V>(value, "value");
            ...
            var secondDimentionData = new MultiDimensionalDictionary<K2, K3, K4, K5, K6, K7, V>();
...
#region Get
public MultiDimensionalDictionary<K2, K3, K4, K5, K6, K7, V> Get(K1 k1)
            {
                return Data[k1];
            }

public MultiDimensionalDictionary<K3, K4, K5, K6, K7, V> Get(K1 k1, K2 k2)
            {
                return Data[k1].Get(k2);
            }

public MultiDimensionalDictionary<K4, K5, K6, K7, V> Get(K1 k1, K2 k2, K3 k3)
            {
                return Data[k1].Get(k2, k3);
            }

public MultiDimensionalDictionary<K5, K6, K7, V> Get(K1 k1, K2 k2, K3 k3, K4 k4)
            {
                return Data[k1].Get(k2, k3, k4);
            }

public MultiDimensionalDictionary<K6, K7, V> Get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5)
            {
                return Data[k1].Get(k2, k3, k4, k5);
            }

public MultiDimensionalDictionary<K7, V> Get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6)
            {
...
DictionaryAssertions.AssertNotNull<K7>(k7, "k7");
            ...
            if (Data.TryGetValue(k1, out MultiDimensionalDictionary<K2, K3, K4, K5, K6, K7, V> secondDimensionData))
            {
                return secondDimensionData.Get(k2, k3, k4, k5, k6, k7);
            }
