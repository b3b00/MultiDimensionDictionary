...
namespace multiDimensionalDictionary
{
    ...
    public class ExpirationalMultiDimensionDictionary<K1, K2, K3, K4, K5, V> //: ExpirationalMultiDimensionDictionary<K1, K2, ExpirationalMultiDimensionDictionary<K3, K4, V>>
    {
        protected new ConcurrentDictionary<K1, (DateTime date, ExpirationalMultiDimensionDictionary<K2, K3, K4, K5, V> data)>  Data { get; set; }
