...
namespace multiDimensionalDictionary
{
    ...
    public class ExpirationalMultiDimensionDictionary<K1, K2, K3, K4, K5, K6, K7, K8, K9, V>
    {
        ...
        public ExpirationalMultiDimensionDictionary(TimeSpan expiration1, TimeSpan expiration2, TimeSpan expiration3,
            ...
            TimeSpan expiration8, TimeSpan expiration9)
        {
            ...
            Data =
                new ConcurrentDictionary<K1, (DateTime date,
                    ExpirationalMultiDimensionDictionary<K2, K3, K4, K5, K6, K7, K8, K9, V> subData)>();
        }
        ...
        public ExpirationalMultiDimensionDictionary(long expiration1, long expiration2, long expiration3,
            ...
            : this(TimeSpan.FromMilliseconds(expiration1), TimeSpan.FromMilliseconds(expiration2),
                ...
                TimeSpan.FromMilliseconds(expiration9))
        {
        }

        protected ConcurrentDictionary<K1, (DateTime date,
            ExpirationalMultiDimensionDictionary<K2, K3, K4, K5, K6, K7, K8, K9, V> subData)> Data { get; set; }
        ...
        public List<(K1, K2, K3, K4, K5, K6, K7, K8, K9)> GetKeys()
        {
            Invalidate();
            var keys = new List<(K1, K2, K3, K4, K5, K6, K7, K8, K9)>();
            foreach (var kvp in Data)
            {
                List<(K2, K3, K4, K5, K6, K7, K8, K9)> subkeys = kvp.Value.subData.GetKeys();
                foreach (var subkey in subkeys)
                {
                    keys.Add((kvp.Key, subkey.Item1, subkey.Item2, subkey.Item3, subkey.Item4, subkey.Item5,
                        subkey.Item6, subkey.Item7, subkey.Item8));
                }
            }
        ...
        public void Put(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8, K9 k9, V value)
        {
            Invalidate();
            ...
            var secondDimentionData = new ExpirationalMultiDimensionDictionary<K2, K3, K4, K5, K6, K7, K8, K9, V>(
                ExpirationSpan2, ExpirationSpan3, ExpirationSpan4, ExpirationSpan5, ExpirationSpan6, ExpirationSpan7,
                ExpirationSpan8, ExpirationSpan9);
            ...
            secondDimentionData.Put(k2, k3, k4, k5, k6, k7, k8, k9, value);
        ...
        public ExpirationalMultiDimensionDictionary<K2, K3, K4, K5, K6, K7, K8, K9, V> Get(K1 k1)
        {
            return Data[k1].subData;
        }

        public ExpirationalMultiDimensionDictionary<K3, K4, K5, K6, K7, K8, K9, V> Get(K1 k1, K2 k2)
        {
            return Data[k1].subData.Get(k2);
        }

        public ExpirationalMultiDimensionDictionary<K4, K5, K6, K7, K8, K9, V> Get(K1 k1, K2 k2, K3 k3)
        {
            return Data[k1].subData.Get(k2, k3);
        }

        public ExpirationalMultiDimensionDictionary<K5, K6, K7, K8, K9, V> Get(K1 k1, K2 k2, K3 k3, K4 k4)
        {
            return Data[k1].subData.Get(k2, k3, k4);
        }

        public ExpirationalMultiDimensionDictionary<K6, K7, K8, K9, V> Get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5)
        {
            return Data[k1].subData.Get(k2, k3, k4, k5);
        }

        public ExpirationalMultiDimensionDictionary<K7, K8, K9, V> Get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6)
        {
            return Data[k1].subData.Get(k2, k3, k4, k5, k6);
        }

        public ExpirationalMultiDimensionDictionary<K8, K9, V> Get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7)
        {
            return Data[k1].subData.Get(k2, k3, k4, k5, k6, k7);
        }

        public ExpirationalMultiDimensionDictionary<K9, V> Get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8)
        {
            return Data[k1].subData.Get(k2, k3, k4, k5, k6, k7, k8);
        }

        public V Get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8, K9 k9)
        {
            Invalidate();
            DictionaryAssertions.AssertNotNull<K1>(k1, "k1");
            ...
            {
                return secondDimensionData.subData.Get(k2, k3, k4, k5, k6, k7, k8, k9);
            }
        ...
        {
            (DateTime date, ExpirationalMultiDimensionDictionary<K2, K3, K4, K5, K6, K7, K8, K9, V> subData) ignore =
                default;
