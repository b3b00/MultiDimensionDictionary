...
namespace multiDimensionalDictionary
{
    ...
    public class ExpirationalMultiDimensionDictionary<K1, K2, K3, K4, K5, V>
    {
            ...
            TimeSpan expiration4, TimeSpan expiration5)
        {
            ...
            Data =
                new ConcurrentDictionary<K1, (DateTime date, ExpirationalMultiDimensionDictionary<K2, K3, K4, K5, V>
                    subData)>();
        }
        ...
        protected ConcurrentDictionary<K1, (DateTime date, ExpirationalMultiDimensionDictionary<K2, K3, K4, K5, V>
        ...
        public void Put(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, V value)
        {
            ...
            var secondDimentionData = new ExpirationalMultiDimensionDictionary<K2, K3, K4, K5, V>(ExpirationSpan2,
