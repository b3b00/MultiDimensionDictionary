...
namespace multiDimensionalDictionary
{
    ...
    public class ExpirationalMultiDimensionDictionary<K1, K2, K3, K4, K5, K6, V>
    {
            ...
            TimeSpan expiration4, TimeSpan expiration5, TimeSpan expiration6)
        {
            ...
            Data =
                new ConcurrentDictionary<K1, (DateTime date, ExpirationalMultiDimensionDictionary<K2, K3, K4, K5, K6, V>
                    subData)>();
        }
        ...
        protected ConcurrentDictionary<K1, (DateTime date, ExpirationalMultiDimensionDictionary<K2, K3, K4, K5, K6, V>
        ...
        public void Put(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, V value)
        {
            ...
            var secondDimentionData = new ExpirationalMultiDimensionDictionary<K2, K3, K4, K5, K6, V>(ExpirationSpan2,
        ...
        public ExpirationalMultiDimensionDictionary<K2, K3, K4, K5, K6, V> Get(K1 k1)
        {
            return Data[k1].subData;
        }

        public ExpirationalMultiDimensionDictionary<K3, K4, K5, K6, V> Get(K1 k1, K2 k2)
        {
            return Data[k1].subData.Get(k2);
        }

        public ExpirationalMultiDimensionDictionary<K4, K5, K6, V> Get(K1 k1, K2 k2, K3 k3)
        {
            return Data[k1].subData.Get(k2, k3);
        }

        public ExpirationalMultiDimensionDictionary<K5, K6, V> Get(K1 k1, K2 k2, K3 k3, K4 k4)
        {
            return Data[k1].subData.Get(k2, k3, k4);
        }

        public ExpirationalMultiDimensionDictionary<K6, V> Get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5)
        {
        ...
        {
            (DateTime date, ExpirationalMultiDimensionDictionary<K2, K3, K4, K5, K6, V> subData) ignore = default;
