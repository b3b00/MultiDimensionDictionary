...
namespace multiDimensionalDictionary
{
    ...
    public class ExpirationalMultiDimensionDictionary<K1, K2, K3, K4, K5, K6, K7, K8, K9, K10, V>
    {
            ...
            TimeSpan expiration8, TimeSpan expiration9, TimeSpan expiration10)
        {
            ...
            Data =
                new ConcurrentDictionary<K1, (DateTime date,
                    ExpirationalMultiDimensionDictionary<K2, K3, K4, K5, K6, K7, K8, K9, K10, V> subData)>();
        }
        ...
        protected ConcurrentDictionary<K1, (DateTime date,
            ExpirationalMultiDimensionDictionary<K2, K3, K4, K5, K6, K7, K8, K9, K10, V> subData)> Data { get; set; }
        ...
        public void Put(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8, K9 k9, K10 k10, V value)
        {
            ...
            var secondDimentionData = new ExpirationalMultiDimensionDictionary<K2, K3, K4, K5, K6, K7, K8, K9, K10, V>(
        ...
        public ExpirationalMultiDimensionDictionary<K2, K3, K4, K5, K6, K7, K8, K9, K10, V> Get(K1 k1)
        {
            return Data[k1].subData;
        }

        public ExpirationalMultiDimensionDictionary<K3, K4, K5, K6, K7, K8, K9, K10, V> Get(K1 k1, K2 k2)
        {
            return Data[k1].subData.Get(k2);
        }

        public ExpirationalMultiDimensionDictionary<K4, K5, K6, K7, K8, K9, K10, V> Get(K1 k1, K2 k2, K3 k3)
        {
            return Data[k1].subData.Get(k2, k3);
        }

        public ExpirationalMultiDimensionDictionary<K5, K6, K7, K8, K9, K10, V> Get(K1 k1, K2 k2, K3 k3, K4 k4)
        {
            return Data[k1].subData.Get(k2, k3, k4);
        }

        public ExpirationalMultiDimensionDictionary<K6, K7, K8, K9, K10, V> Get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5)
        {
            return Data[k1].subData.Get(k2, k3, k4, k5);
        }

        public ExpirationalMultiDimensionDictionary<K7, K8, K9, K10, V> Get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6)
        {
            return Data[k1].subData.Get(k2, k3, k4, k5, k6);
        }

        public ExpirationalMultiDimensionDictionary<K8, K9, K10, V> Get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7)
        {
            return Data[k1].subData.Get(k2, k3, k4, k5, k6, k7);
        }

        public ExpirationalMultiDimensionDictionary<K9, K10, V> Get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7,
            K8 k8)
        {
            return Data[k1].subData.Get(k2, k3, k4, k5, k6, k7, k8);
        }

        public ExpirationalMultiDimensionDictionary<K10, V> Get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8,
            K9 k9)
        {
        ...
        {
            (DateTime date, ExpirationalMultiDimensionDictionary<K2, K3, K4, K5, K6, K7, K8, K9, K10, V> subData)
                ignore = default;
